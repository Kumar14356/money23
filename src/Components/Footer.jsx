      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="text-start">
            ...
            <li><a href="#" className="text-black hover:text-cyan-500 transition-colors">Borrowers</a></li>
              <li><a href="#" className="text-black hover:text-cyan-500 transition-colors">For Brokers</a></li>
              <li><a href="#" className="text-black hover:text-cyan-500 transition-colors">Our Features</a></li>
              <li><a href="#" className="text-black hover:text-cyan-500 transition-colors">Our Story</a></li>
            </ul>
          </div>
          ...
          <div className="text-start">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-black hover:text-cyan-500 transition-colors">Apply For Finance</a></li>
              <li><a href="#" className="text-black hover:text-cyan-500 transition-colors">Open a Free Broker Account</a></li>
              <li><a href="#" className="text-black hover:text-cyan-500 transition-colors">Become a Lender Partner</a></li>
            </ul>
          </div>
          ...
          <div className="text-start">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-black hover:text-cyan-500 transition-colors">Contact Us</a></li>
              <li><a href="#" className="text-black hover:text-cyan-500 transition-colors">Our Guides</a></li>
              <li><a href="#" className="text-black hover:text-cyan-500 transition-colors">Terms of Business</a></li>
              <li><a href="#" className="text-black hover:text-cyan-500 transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="text-black hover:text-cyan-500 transition-colors">Complaints</a></li>
            </ul>
          </div>
